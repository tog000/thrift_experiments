...
public class Httpd {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String thriftEndpoint = "/thrift/mathoperations";
        if (args.length < 3) {
            System.err.println("Usage: Httpd <port> <root directory> <thrift endpoint>");
            System.exit(1);
        }
        Thread t = new RequestListenerThread(port, rootDirectory, thriftEndpoint);
        t.setDaemon(false);
        t.start();
    }
    ...
    static class HttpFileHandler implements HttpRequestHandler {
        ...
        private final String docRoot,endpoint;

        public HttpFileHandler(final String docRoot, final String endpoint) {
            super();
        ...
        public void handle(final HttpRequest request, final HttpResponse response, final HttpContext context) throws HttpException, IOException {
            ...
            if (request instanceof HttpEntityEnclosingRequest && target.startsWith(endpoint)) {
        ...
        private String thriftRequest(byte[] input){
            try{
                ...
                TProcessor processor = processor = new MathOperations.Processor<MathOperationsHandler>(new MathOperationsHandler());       
    ...
    static class RequestListenerThread extends Thread {
        ...
        public RequestListenerThread(int port, final String docroot, String endpoint) throws IOException {
            ...
            reqistry.register("*", new HttpFileHandler(docroot, endpoint));
